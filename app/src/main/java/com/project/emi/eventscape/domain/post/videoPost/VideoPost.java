...
import com.project.emi.eventscape.Application;
...
import static com.project.emi.eventscape.core.managers.DatabaseHelper.IMAGES_STORAGE_KEY;
...
public class VideoPost extends AppCompatActivity
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            RenderersFactory renderersFactory =
                    ((Application) getApplication()).buildRenderersFactory(preferExtensionDecoders);
    ...
    private MediaSource createTopLevelMediaSource(Intent intent) {
        ...
        DatabaseHelper.getInstance(this).getStorageReference().child(IMAGES_STORAGE_KEY).child("post_-Lyt2W7lEBCJuslNTpg__1579357704754").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                Sample.UriSample sample = new Sample.UriSample("Dummy uri", uri,"mp4", false , null, null, null, null   );
    ...
    private HttpMediaDrmCallback createMediaDrmCallback(
        ...
        HttpDataSource.Factory licenseDataSourceFactory =
                ((Application) getApplication()).buildHttpDataSourceFactory();
    ...
    private DataSource.Factory buildDataSourceFactory() {
        return ((Application) getApplication()).buildDataSourceFactory();
    }
            ...
            MediaSourceFactory adMediaSourceFactory =
                    new MediaSourceFactory() {
                        ...
                        public MediaSource createMediaSource(Uri uri) {
                            return VideoPost.this.createLeafMediaSource(
