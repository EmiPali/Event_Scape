...
import com.project.emi.eventscape.adapters.PostsByUserAdapter;
import com.project.emi.eventscape.core.dialogs.UnfollowConfirmationDialog;
...
public class NewProfileActivity extends BaseActivity<ProfileView, ProfilePresenter> implements ProfileView, GoogleApiClient.OnConnectionFailedListener, UnfollowConfirmationDialog.Callback {
    ...
    private static final String TAG = NewProfileActivity.class.getSimpleName();
    // UI references.
...
//                    break;
    ...
    private void startUsersListActivity(int usersListType) {
        Intent intent = new Intent(NewProfileActivity.this, UsersListActivity.class);
    ...
    public void openPostDetailsActivity(Post post, View v) {
        Intent intent = new Intent(NewProfileActivity.this, PostDetailsActivity.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            ActivityOptions options = ActivityOptions.
                    makeSceneTransitionAnimation(NewProfileActivity.this,
...
//        startActivityForResult(intent, CreatePostActivity.CREATE_NEW_POST_REQUEST);
    ...
    public void setDefaultProfilePhoto() {
        progressBar.setVisibility(View.GONE);
        imageView.setImageResource(R.drawable.ic_black_x);
    }
    ...
    @Override
    public void showUnfollowConfirmation(@NonNull User profile) {
