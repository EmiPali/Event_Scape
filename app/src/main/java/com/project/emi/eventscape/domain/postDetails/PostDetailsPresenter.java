...
import com.project.emi.eventscape.core.managers.CommentManager;
...
class PostDetailsPresenter extends BasePresenter<PostDetailsView> {
    ...
    private void loadAuthorProfile() {
        if (post != null && post.getAuthorId() != null) {
            profileManager.getProfileSingleValue(post.getAuthorId(), new OnObjectChangedListenerSimple<User>() {
                @Override
                public void onObjectChanged(User profile) {
                    ifViewAttached(view -> {
